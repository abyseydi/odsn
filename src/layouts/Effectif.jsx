  ...
  return (
    <div className="min-h-screen p-6 p-8 flex flex-col md:flex-row gap-8 items-start justify-center">
      ...
      <div className="bg-gray-200  border-l-4 border-blue-500 rounded-xl shadow-lg w-full md:w-[650px] p-8 space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold mb-3 text-gray-700">Localisation et Type d'Événement</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                {[
                  "Dakar", "Thiès", "Saint-Louis", "Kaolack", "Diourbel", "Fatick",
                  "Kaffrine", "Kédougou", "Kolda", "Louga", "Matam", "Sédhiou",
        ...
        <div>
          <h2 className="text-lg font-semibold mb-3 text-gray-700">Évaluation des Risques et Affluence</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-lg">{affluence}</span>
                <button
        ...
        <div>
          <h2 className="text-lg font-semibold mb-3 text-gray-700">Planification</h2>
