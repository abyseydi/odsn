...
//                 label={{
//                   value: "Couverture sanitaire",
//                   angle: -90,
//                   position: "insideLeft",
//                 }}
//               />
//               <Tooltip
//                 formatter={(value, name) => [`${value}`, "Couverture"]}
//               />
//               <Line
//                 type="monotone"
//                 dataKey="couv_san"
...
//                 </td>
//                 <td className="px-4 py-2 border">
//                   {row.ajouter != null ? Math.round(row.ajouter) : "-"}
//                 </td>
//               </tr>
//             ))}
//           </tbody>
...
// ✅ Composant ANSDHome avec DAKAR comme région par défaut
import { Link } from "react-router-dom";
import React, { useEffect, useState } from "react";
import {
  Tabs, TabsHeader, TabsBody, Tab, TabPanel,
