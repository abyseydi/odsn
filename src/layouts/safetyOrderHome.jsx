  ...
  return (
    <div
      className="
        ...
        rounded-3xl bg-white/95 border border-blue-200
        p-5 sm:p-6 md:p-8
        shadow-[0_10px_0_0_rgba(60,90,200,0.20),0_24px_40px_-12px_rgba(0,0,0,0.15)]
        transition-transform duration-200 hover:-translate-y-1
      "
    ...
    >
      ...
      <div
        className="
          mx-auto mb-5 flex h-24 w-24 sm:h-28 sm:w-28 items-center justify-center
          rounded-2xl border border-blue-100 bg-white
          shadow-[0_6px_18px_-6px_rgba(0,0,0,0.15)]
        "
      >
      ...
      <button
        onClick={onClick}
        className="
          w-full sm:w-auto mx-auto block rounded-full px-6 sm:px-8 py-2.5 sm:py-3
  ...
  return (
    <section
      className="
        ...
        min-h-[100svh]  /* mieux que h-screen sur mobile */
        overflow-hidden
      "
      aria-label="Accueil Forces de Défense et de Sécurité"
    >
      ...
      {/* Overlay léger (renforcé sur mobile pour la lisibilité) */}
      <div className="absolute inset-0 -z-10 bg-white/15 sm:bg-white/10 md:bg-white/0" />

      {/* Contenu */}
      <div className="relative z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-10 py-8 sm:py-10 lg:py-12">
      ...
      {/* WARNING (réactif, lisible, ne chevauche pas les cartes) */}
      <div
        className="
          absolute bottom-3 sm:bottom-4 left-1/2 -translate-x-1/2
          w-[92%] sm:w-[85%] md:w-[70%] max-w-3xl
          px-3 sm:px-4
        "
      >
        <div
        ...
        >
          <div className="flex flex-col items-center text-center gap-2 sm:gap-2.5">
            ...
            />
            <p className="text-gray-800 text-[11px] sm:text-sm md:text-base leading-relaxed">
              Ce module développé pour les Forces de Défense et de Sécurité contient des
              données sensibles et confidentielles. L’accès à son contenu est strictement
              réservé aux utilisateurs autorisés.
            </p>
