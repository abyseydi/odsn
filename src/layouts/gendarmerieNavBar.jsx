  ...
  return (
    <aside className="hidden md:flex flex-col justify-between absolute top-1/2 -translate-y-1/2 left-0 w-[250px] h-[85%] bg-white rounded-2xl shadow-xl z-20 m-4 p-6">
      ...
      <div className="text-center mt-6">
        ...
        <Link
          to="/" // ✅ route vers ta landing page
          className="mt-4 inline-block px-4 py-2 text-sm font-medium text-white bg-[#1e2454] rounded-lg shadow hover:bg-[#0f1633] transition-all"
        >
          Retour à l’accueil
        </Link>
      </div>
