  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:space-x-4 space-y-3 md:space-y-0 mb-6">
        ...
        <SelectInput label="Trimestre" name="trimestre" options={getAvailableTrimestres(formData.annee)} onChange={handleChange} value={formData.trimestre} />
        <SelectInput label="Catégorie" name="categorie" options={["Toutes les catégories", ...categories]} onChange={handleChange} value={formData.categorie} />
      </div>

      {/* Tableau + Graphique en responsive */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          ...
          {filteredPrediction.length === 0 ? (
            ...
            <div className="w-full h-[200px] md:h-[3S00px]">
